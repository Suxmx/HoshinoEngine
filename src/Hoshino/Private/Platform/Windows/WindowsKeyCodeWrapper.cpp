...
namespace Hoshino
{
	...
	int KeyCodeToGlfwKey(KeyCode keyCode)
	{
		...
		static const std::unordered_map<KeyCode, int> glfwKeyMap = {
		    ...
		    {KeyCode::Key0, GLFW_KEY_0},
		    {KeyCode::Key1, GLFW_KEY_1},
		    {KeyCode::Key2, GLFW_KEY_2},
		    {KeyCode::Key3, GLFW_KEY_3},
		    {KeyCode::Key4, GLFW_KEY_4},
		    {KeyCode::Key5, GLFW_KEY_5},
		    {KeyCode::Key6, GLFW_KEY_6},
		    {KeyCode::Key7, GLFW_KEY_7},
		    {KeyCode::Key8, GLFW_KEY_8},
		    {KeyCode::Key9, GLFW_KEY_9},
		    ...
		    {KeyCode::World1, GLFW_KEY_WORLD_1},
		    {KeyCode::World2, GLFW_KEY_WORLD_2},
